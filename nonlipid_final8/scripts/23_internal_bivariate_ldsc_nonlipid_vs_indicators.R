...
repo_dir <- "D:/codex/metabolic_repo/nonlipid_final8"
std_dir <- file.path(
  root_dir,
...
ascii_work_dir <- "D:/codex/GenomicSEM/metabolic/step25_internal_nonlipid_ldsc_work"
out_dir <- file.path(root_dir, "step25_internal_bivariate_nonlipid_final8")
...
ldsc_out <- ldsc(
  ...
  ldsc.log = file.path(out_dir, "nonlipid_internal_bivariate_ldsc")
)

saveRDS(ldsc_out, file.path(out_dir, "nonlipid_internal_bivariate_ldsc.rds"))
...
fwrite(traits_manifest, file.path(out_dir, "nonlipid_internal_validation_traits_manifest.tsv"), sep = "\t")
fwrite(diag_dt, file.path(out_dir, "nonlipid_internal_bivariate_ldsc_h2.tsv"), sep = "\t")
fwrite(as.data.table(R, keep.rownames = "trait"), file.path(out_dir, "nonlipid_internal_bivariate_ldsc_rg_matrix.tsv"), sep = "\t")
fwrite(pairs_dt, file.path(out_dir, "nonlipid_internal_bivariate_ldsc_requested_pairs.tsv"), sep = "\t")
fwrite(summary_dt, file.path(out_dir, "nonlipid_internal_bivariate_ldsc_pairset_summary.tsv"), sep = "\t")
fwrite(dcast_dt, file.path(out_dir, "nonlipid_internal_bivariate_ldsc_factor_contrast.tsv"), sep = "\t")

message("Nonlipid internal validation written to: ", out_dir)
