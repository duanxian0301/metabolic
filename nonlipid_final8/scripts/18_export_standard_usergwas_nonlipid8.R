...
meta <- data.table(
  ...
  notes = "Native WSL GenomicSEM userGWAS rerun on nonlipid final8 3-factor model; FREQ uses MAF; CHR/BP merged from D:/SMR/g1000/g1000_eur.bim when available; N replaced with factor-specific Neff estimated as mean(1/(2*MAF*(1-MAF)*SE^2)) across SNPs with 0.1<=MAF<=0.4."
)
