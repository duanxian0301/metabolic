...
repo_dir <- "D:/codex/metabolic_repo/external_support_karjalainen233/inputs/external_bivariate_round1/nonlipid"
ascii_work_dir <- "D:/codex/GenomicSEM/metabolic/external_bivariate_nonlipid_round1_work"
out_dir <- "D:/metabolic/233/ldsc_univariate/external_bivariate_round1_nonlipid"
...
ldsc_out <- ldsc(
  ...
  ldsc.log = file.path(out_dir, "external_bivariate_nonlipid_round1")
)

saveRDS(ldsc_out, file.path(out_dir, "external_bivariate_nonlipid_round1.rds"))
...
fwrite(traits_manifest, file.path(out_dir, "external_bivariate_nonlipid_round1_traits_manifest.tsv"), sep = "\t")
fwrite(diag_dt, file.path(out_dir, "external_bivariate_nonlipid_round1_h2.tsv"), sep = "\t")
fwrite(as.data.table(R, keep.rownames = "trait"), file.path(out_dir, "external_bivariate_nonlipid_round1_rg_matrix.tsv"), sep = "\t")
fwrite(pairs_dt, file.path(out_dir, "external_bivariate_nonlipid_round1_requested_pairs.tsv"), sep = "\t")
fwrite(summary_dt, file.path(out_dir, "external_bivariate_nonlipid_round1_pairset_summary.tsv"), sep = "\t")
fwrite(contrast_dt, file.path(out_dir, "external_bivariate_nonlipid_round1_factor_contrast.tsv"), sep = "\t")

message("External nonlipid round1 bivariate LDSC written to: ", out_dir)
