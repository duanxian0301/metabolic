...
OUT_DIR = Path(r"D:/codex/metabolic_repo/external_support_karjalainen233/inputs/external_bivariate_round1")


LIPID_ACCESSIONS = [
    "GCST90302041",  # M_HDL_TG
    "GCST90302055",  # MUFA
    "GCST90302124",  # VLDL size
    "GCST90301945",  # ApoA1
    "GCST90302154",  # XS_VLDL_FC
]

NONLIPID_ACCESSIONS = [
    "GCST90301948",  # bOHbutyrate
    "GCST90301994",  # Leucine
    "GCST90302070",  # Phenylalanine
    "GCST90302122",  # Valine
    "GCST90301964",  # Glucose
]
...
def build_module(module_name, accessions, factors):
    ...
    dt["pair_set_anchor"] = dt["validation_priority"].fillna("unclassified")
            ...
            pair_rows.append(
                {
                    ...
                    "pair_set": "primary_match" if factor == row["anchor_factor"] else "cross_factor",
                    "expected_alignment": "primary" if factor == row["anchor_factor"] else "nonprimary",
                }
            )
